...
def main():
    ...
    predCoarseLabels = coarseModel.predict(combinedCoarseTfIdf)
    oneHotForCoarseLabels = convertToOneHotCoarse(
        predCoarseLabels, coarseLabelToIndex)
    predFile = argv[9]
    ...
    combinedWithCoarse = hstack([combinedTestTFIdf, oneHotForCoarseLabels])
